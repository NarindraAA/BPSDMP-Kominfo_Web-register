    ...
    <div class="card">
      <div class="card-body">
        ...
        if ($_GET['key'] && $_GET['reset']) {
          ...
          $select = mysqli_query($koneksi, "SELECT email, password FROM tb_admin WHERE email='$ml' AND md5(password)='$pass'");
            ...
            <form action="" method="POST">
              <div class="form-group">
                ...
                <div class="form-floating mb-3">
                  <input type="password" class="form-control" name="password" id="password" onkeyup='check();' placeholder="*********" required>
        ...
        if (isset($_POST['submit_password'])) {
          ...
          if (strlen($password_baru) >= 5) {
            if ($password_baru == $konfirmasi_password) {
              $email = $_POST['email'];
              $pass = $_POST['password'];
              $update = mysqli_query($koneksi, "UPDATE tb_admin SET password='$pass' WHERE email='$ml'");
              if ($update) {
